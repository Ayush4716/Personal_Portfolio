  ...
  return (
    <div className="wrapper">
       ...
       <p>
        ...
        <p>
          I am always looking to improve my skills and say up-to-date with the latest best practices
          in web development. I am excited to continue growing as a developer and making meaningful contributions to projects and teams.
        </p>
    </div>
    </div>
  )
